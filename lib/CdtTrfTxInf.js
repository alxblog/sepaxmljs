...
const CdtTrfTxInfSchema = require('../schemas/CdtTrfTxInfSchema')
  ...
  * @todo TODO: this.toString() handle promise rejection 
  */
...
CdtTrfTxInf.prototype.toString = function(){
    ...
    validate(transaction, CdtTrfTxInfSchema)
      .then((parsedValues) => {
        return parsedValues
      })
      .catch((errors) => {

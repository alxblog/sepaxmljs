...
var PmtInf = require('./PmtInf');
  ...
  * @param {string} [options.version=urn:iso:std:iso:20022:tech:xsd:pain.001.001.03] xmlns: SEPA XML pain version  
...
function SepaXML(options) {
    this.version = options.version || "urn:iso:std:iso:20022:tech:xsd:pain.001.001.03";
    this.debitor = options.debitor;
